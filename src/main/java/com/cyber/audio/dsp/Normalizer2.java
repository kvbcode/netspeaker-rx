...
import com.cyber.array.IntStatArray;
 ...
 * @author CyberManic
 */
public class Normalizer2 extends AudioProcessor implements INormalizer{
    ...
    protected final IntStatArray statArr = new IntStatArray(5000);
    ...
    public Normalizer2(AudioFormat format){
        super(format);
    }
